                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body p-4">
                            <div class="row g-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-label">Auto Payment Verification Type</label>
                                        <div class="form-control-wrap">
                                            <select class="js-select" name="auto_verify_type" required>
                                                <option value="trxid" <?php echo (($global_response_brand['response'][0]['auto_verify_type'] ?? 'trxid') === 'trxid') ? 'selected' : ''; ?>>Transaction ID</option>
                                                <option value="phone" <?php echo (($global_response_brand['response'][0]['auto_verify_type'] ?? 'trxid') === 'phone') ? 'selected' : ''; ?>>Phone Number</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
